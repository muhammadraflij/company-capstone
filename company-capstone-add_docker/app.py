...
from colect_weather import data_by_city, data_by_location
from list_to_dict import list_to_dict, list_to_dict_prov
from current_weather import current_aqi_prov

app = Flask(__name__)
  
# load model
model = load_model("C:\Users\Eko Bagus Yanuar\Videos\company-capstone-add_docker\Model\lstm_6_3_e50\my_model_weather (1).h5")
